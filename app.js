...
const PRESET_COVERS = {
  'neon-executor': `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><defs><linearGradient id="g1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%230c0e14"/><stop offset="100%" stop-color="%23030407"/></linearGradient><linearGradient id="glow" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="%238b5cf6"/><stop offset="100%" stop-color="%2306b6d4"/></linearGradient></defs><rect width="800" height="600" fill="url(%23g1)"/><circle cx="700" cy="120" r="220" fill="%238b5cf6" opacity="0.2" filter="blur(50px)"/><circle cx="100" cy="480" r="200" fill="%2306b6d4" opacity="0.18" filter="blur(50px)"/><path d="M 50 200 L 750 200" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><path d="M 50 400 L 750 400" stroke="rgba(255,255,255,0.05)" stroke-width="1"/><rect x="70" y="80" width="660" height="440" rx="18" fill="rgba(14,16,24,0.85)" stroke="rgba(139,92,246,0.35)" stroke-width="2"/><text x="110" y="160" fill="%23c4b5fd" font-family="monospace" font-size="32" font-weight="bold">-- [ NEON LUA EXECUTOR ]</text><text x="110" y="230" fill="%2338bdf8" font-family="monospace" font-size="20">loadstring(game:HttpGet("https://publicscript.kr/v3"))()</text><text x="110" y="290" fill="%2334d399" font-family="monospace" font-size="18">&gt; Bypass: ACTIVE | Memory Hook: Injected</text><text x="110" y="340" fill="%23fb7185" font-family="monospace" font-size="18">&gt; FPS Unlocker: 240 FPS Target</text><text x="110" y="390" fill="%23c084fc" font-family="monospace" font-size="18">&gt; Anti-Cheat Protection: Level 9 [Secured]</text><rect x="110" y="440" width="180" height="42" rx="8" fill="url(%23glow)"/><text x="142" y="467" fill="%23ffffff" font-family="sans-serif" font-size="16" font-weight="bold">EXECUTE 4:3</text></svg>`,

  'cyber-hub': `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><defs><linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="%2307080d"/><stop offset="100%" stop-color="%231a1538"/></linearGradient></defs><rect width="800" height="600" fill="url(%23bg)"/><circle cx="400" cy="300" r="220" fill="%23a855f7" opacity="0.22" filter="blur(70px)"/><rect x="80" y="70" width="640" height="460" rx="20" fill="rgba(11,13,22,0.88)" stroke="rgba(168,85,247,0.45)" stroke-width="2"/><circle cx="120" cy="115" r="8" fill="%23f43f5e"/><circle cx="145" cy="115" r="8" fill="%23f59e0b"/><circle cx="170" cy="115" r="8" fill="%2310b981"/><text x="120" y="190" fill="%23c084fc" font-family="monospace" font-size="36" font-weight="900">CYBER HUB v4.2</text><text x="120" y="250" fill="%2394a3b8" font-family="monospace" font-size="19">⚡ Auto Farm • Mastery • Fast Attack • Teleport</text><rect x="120" y="300" width="270" height="52" rx="10" fill="rgba(168,85,247,0.18)" stroke="rgba(168,85,247,0.45)"/><text x="140" y="333" fill="%23f3e8ff" font-family="monospace" font-size="16">Auto-Farm Mob: ENABLED</text><rect x="410" y="300" width="240" height="52" rx="10" fill="rgba(6,182,212,0.18)" stroke="rgba(6,182,212,0.45)"/><text x="430" y="333" fill="%23cffafe" font-family="monospace" font-size="16">Speed: 450 studs/s</text><rect x="120" y="380" width="530" height="52" rx="10" fill="rgba(16,185,129,0.12)" stroke="rgba(16,185,129,0.35)"/><text x="140" y="413" fill="%23a7f3d0" font-family="monospace" font-size="16">🛡️ Anti-Ban Protocol: Verified Active</text></svg>`,

  'esp-radar': `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><defs><radialGradient id="radarG" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="%2310b981" stop-opacity="0.35"/><stop offset="100%" stop-color="%23022c22" stop-opacity="0"/></radialGradient></defs><rect width="800" height="600" fill="%2302110c"/><circle cx="400" cy="300" r="230" fill="url(%23radarG)" stroke="%23059669" stroke-width="1.5" stroke-dasharray="8,5"/><circle cx="400" cy="300" r="150" stroke="%2310b981" stroke-width="1.2"/><circle cx="400" cy="300" r="70" stroke="%2334d399" stroke-width="1.2"/><line x1="400" y1="30" x2="400" y2="570" stroke="%23047857" stroke-width="1.2"/><line x1="130" y1="300" x2="670" y2="300" stroke="%23047857" stroke-width="1.2"/><circle cx="510" cy="230" r="9" fill="%23f43f5e"/><text x="528" y="236" fill="%23fca5a5" font-family="monospace" font-size="15" font-weight="bold">Enemy Target (34m)</text><circle cx="310" cy="390" r="9" fill="%2338bdf8"/><text x="328" y="396" fill="%23bae6fd" font-family="monospace" font-size="15" font-weight="bold">Team Squad (72m)</text><rect x="60" y="50" width="250" height="85" rx="12" fill="rgba(6,40,30,0.85)" stroke="%2310b981" stroke-width="1.5"/><text x="80" y="86" fill="%2334d399" font-family="monospace" font-size="18" font-weight="bold">ESP &amp; CHAMS HUD</text><text x="80" y="115" fill="%236ee7b7" font-family="monospace" font-size="14">3D Box | Tracers | Distance</text></svg>`,

  'dark-config': `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600"><rect width="800" height="600" fill="%23080b12"/><rect x="60" y="50" width="680" height="500" rx="16" fill="%230e1422" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/><text x="90" y="110" fill="%23f59e0b" font-family="monospace" font-size="22" font-weight="bold"># SERVER CONFIGURATION 4:3 (.TXT)</text><text x="90" y="170" fill="%2394a3b8" font-family="monospace" font-size="17">[NetworkSettings]</text><text x="90" y="210" fill="%23e2e8f0" font-family="monospace" font-size="17">MaxConcurrentConnections = 2048</text><text x="90" y="250" fill="%23e2e8f0" font-family="monospace" font-size="17">RateLimitPerSecond = 100</text><text x="90" y="310" fill="%2394a3b8" font-family="monospace" font-size="17">[SecurityHooks]</text><text x="90" y="350" fill="%2310b981" font-family="monospace" font-size="17">AntiPacketInject = true</text><text x="90" y="390" fill="%2310b981" font-family="monospace" font-size="17">BypassDetectionLevel = "Maximum-Aggressive"</text><text x="90" y="450" fill="%23c4b5fd" font-family="monospace" font-size="17">[OutputLog]</text><text x="90" y="490" fill="%2338bdf8" font-family="monospace" font-size="17">Status = 200 OK (Render Aspect 4:3 Verified)</text></svg>`
};
